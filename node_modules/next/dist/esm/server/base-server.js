...
import { RSC, RSC_VARY_HEADER, FLIGHT_PARAMETERS, NEXT_RSC_UNION_QUERY, NEXT_ROUTER_PREFETCH, RSC_CONTENT_TYPE_HEADER } from "../client/components/app-router-headers";
...
export default class Server {
    async getPrefetchRsc(_pathname) {
        return null;
    }
    constructor(options){
